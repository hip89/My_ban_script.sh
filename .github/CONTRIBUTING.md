...
[create a ticket](https://github.com/kevalpatel2106/crypto-wallet/issues/new). No idea is bad, no opinion is wrong. 
...
```
git clone https://github.com/kevalpatel2106/crypto-wallet.git
```
